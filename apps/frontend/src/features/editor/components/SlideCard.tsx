  ...
  return (
    ...
    >
      ...
      <button
        ref={btnRef}
        type="button"
        aria-label="Abrir menú de diapositiva"
        onClick={() => setMenuOpen((v) => !v)}
        className="absolute left-2 top-2 inline-flex h-6 w-6 items-center justify-center rounded-md border border-zinc-200 dark:border-zinc-600 bg-white/90 dark:bg-zinc-800/90 text-zinc-600 dark:text-zinc-300 shadow-sm backdrop-blur hover:bg-white dark:hover:bg-zinc-700"
      >
      ...
      >
        <button
          ...
          className="flex w-full items-center gap-2 rounded-md px-2.5 py-2 text-left text-xs font-medium text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-700"
        >
        ...
        <button
          ...
          className="flex w-full items-center gap-2 rounded-md px-2.5 py-2 text-left text-xs font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950"
        >
